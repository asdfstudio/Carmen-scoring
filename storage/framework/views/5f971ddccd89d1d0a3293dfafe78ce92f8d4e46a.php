<?php $__env->startSection('title'); ?>
  <?php echo e($competition->name); ?> | @parent
...
<?php $__env->startSection('content'); ?>
  ...
  <ul class="actions-group mv">
    <?php if (app('Illuminate\Contracts\Auth\Access\Gate')->check('activateScoring', $competition)): ?>
      <li><?php echo form($activateScoringForm); ?></li>
    <?php endif; ?>
    <?php if (app('Illuminate\Contracts\Auth\Access\Gate')->check('archiveCompetition', $competition)): ?>
      <li><?php echo form($archiveCompetitionForm); ?></li>
    <?php endif; ?>
    <?php if (app('Illuminate\Contracts\Auth\Access\Gate')->check('completeScoring', $competition)): ?>
  ...
  <?php if($competition->divisions->count() > 0): ?>
    ...
    <?php echo $__env->make('division.organizer.list',['divisions' => $competition->divisions], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <?php if($competition->soloDivisions->count() > 0): ?>
    ...
    <?php echo $__env->make('solo-division.organizer.list',['soloDivisions' => $competition->soloDivisions], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php else: ?>
  ...
  <?php echo $__env->make('schedule.organizer.table', ['schedules' => $competition->schedules], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <?php echo $__env->make('award-schedule.organizer.table', ['schedules' => $competition->awardSchedules], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
