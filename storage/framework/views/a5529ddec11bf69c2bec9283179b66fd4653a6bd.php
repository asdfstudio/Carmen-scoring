...
<?php $__env->startSection('content'); ?>
	...
	<ul class="actions-group mv">
		...
		<li><?php echo e(link_to_route('organizer.competition.division.show', 'Exit Set Up Mode', [$competition,$division],['class' => 'action'])); ?></li>
  ...
  <div class="division-board" id="division-13-board">
    ...
    <?php echo $__env->make('choir.board.board-list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<?php echo $__env->make('judge.board.board-list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<?php echo $__env->make('round.board.board-list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
