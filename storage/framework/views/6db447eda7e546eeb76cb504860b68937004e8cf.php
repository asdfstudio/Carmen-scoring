<?php $__env->startSection('content-header'); ?>
  ...
  <?php echo e(link_to_route('judge.round.scores.summary', 'Go to Summary View', [$competition, $division, $round], ['class' => 'action'])); ?>
  ...
  <?php if(isset($round) AND isset($division->rounds)): ?>
    <div class="round-navigation-bar body-width">
      <ul class="round-navigation">
        <?php foreach($division->rounds as $rd): ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <?php echo $__env->make('scores.spreadsheet-legend', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
