...
<?php $__env->startSection('content'); ?>
  ...
  <div style="padding: 0 0 0 40px;">
    ...
    <div style="padding: 10px 0 10px 40px;">
      ...
      <!--
      <h4><a href="<?php echo e(route('dedup.dup_list')); ?>">Browse Duplicates</a></h4>
      ...
      <h4><a href="<?php echo e(route('dedup.convert_person_type_choir')); ?>">Convert Person, Type, &amp; Choir Relationships</a></h4>
      ...
      <h4><a href="<?php echo e(route('dedup.merge_dups')); ?>">Merge Duplicates Automatically</a></h4>
      
      <p>On this page, you can run a script to merge duplicate person records based on email and name/school association.</p>
      
      <hr>
      
      <h4><a href="<?php echo e(route('dedup.merge_dups_manual')); ?>">Merge Duplicates Manually</a></h4>
      ...
      <h4><a href="<?php echo e(route('dedup.delete_blanks')); ?>">Delete Blank Records</a></h4>
  ...
  <div style="padding: 0 0 0 40px;">
    ...
    <div style="padding: 10px 0 10px 40px;">
      ...
      <!--
      <h4><a href="<?php echo e(route('dedup.dup_list_schools')); ?>">Browse Duplicates</a></h4>
      ...
      <h4><a href="<?php echo e(route('dedup.merge_dup_schools_manual')); ?>">Merge Duplicates Manually</a></h4>
  ...
  <div style="padding: 0 0 0 40px;">
    ...
    <div style="padding: 10px 0 10px 40px;">
      ...
      <h4><a href="<?php echo e(route('dedup.merge_dup_choirs_manual')); ?>">Merge Duplicates Manually</a></h4>
