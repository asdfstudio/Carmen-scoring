...
class CompetitionDivisionRoundChoirJudgeController extends Controller
{
    public function index($competition,$division_id,$round_id,$choir_id)
		...
		public function show_ranked($competition_id,$division_id,$round_id,$choir_id,$judge_id)
		{
			$scoreboard = new Scoreboard([
				'division_id' => $division_id,
				'round_id' => $round_id,
			...
			return view('competition_division_round_choir_judge.judge.show_ranked',compact('rankedScores','captions','round','judge','choir'));
		}
}
