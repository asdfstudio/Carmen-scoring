...
Route::group([
  ...
  Route::get('competition/{competition}/division/{division}/choir/{choir}/penalty', [
    'as' => 'competition.division.penalty.choir.assign', 'uses' => 'CompetitionDivisionRoundChoirController@assign_penalty'
	]);

  // Save assigned penalties to choir
  Route::post('competition/{competition}/division/{division}/choir/{choir}/penalty', [
    'as' => 'competition.division.penalty.choir.update_assign', 'uses' => 'CompetitionDivisionRoundChoirController@update_penalty'
	]);
...
Route::post('competition/{competition}/round/{round}/audience/update', [
  ...
  Route::get('competition/{competition}/solo-division/{soloDivision}/performers', [
    'as' => 'competition.solo-division.manage.performers', 'uses' => 'CompetitionSoloDivisionController@managePerformers'
  ]);

  Route::post('competition/{competition}/solo-division/{soloDivision}/performers', [
    'as' => 'competition.solo-division.manage.performers.store', 'uses' => 'CompetitionSoloDivisionController@managePerformersStore'
  ]);
