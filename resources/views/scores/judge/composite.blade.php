    ...
    @foreach($round->choirs as $choir)
      <tr>
        ...
        <td>
          ...
          <?php $weighted = $weightedScores->where('choir_id', $choir->id)->where('criterion.caption_id', $caption->id)->sum('weightedScore');?>
          <span class="weighted score">{{ $weighted }}</span>

          <?php $raw = $rawScores->where('choir_id', $choir->id)->where('criterion.caption_id', $caption->id)->sum('score');?>
          <span class="raw score">{{ $raw }}</span>
        </td>
        <td>
