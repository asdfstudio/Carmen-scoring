...
@section('content')
	...
	<ul class="actions-group mv">
		...
		<li>{{ link_to_route('judge.competition.solo-division.results.female','Female results',[$competition, $soloDivision],['class' => 'action']) }}</li>
		<li>{{ link_to_route('judge.competition.solo-division.results.male','Male results',[$competition, $soloDivision],['class' => 'action']) }}</li>
	</ul>
