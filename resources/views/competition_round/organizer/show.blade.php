...
@section('content')
    ...
    <ul class="list-group">
        <div>
            ...
            <div style="width: 50%;display: inline-block;text-align: right;padding-bottom: 10px">{{ link_to_route('organizer.competition.division.create','Create your class',[$competition], ['class' => 'action']) }}</div>
        </div>
